...
function countKindness(ratings) {
  ...
  if (sumCriterion == 0) {
    ...
    booCriterion = aveCriterion;
  }
  let dict = { criterion: aveCriterion, sum: sumCriterion, boo: booCriterion };
  return dict;
}
