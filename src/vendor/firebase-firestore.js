...
const v = Array.prototype.indexOf
  ? function (e, t) {
...
var S = (function () {
  ...
  try {
    E.addEventListener("test", () => {}, t),
      E.removeEventListener("test", () => {}, t);
  } catch (e) {}
  return e;
})();
function x$1(e) {
...
var D,
  ...
  O =
    ...
    !(y("Trident") || y("MSIE")) &&
    !y("Edge"),
  L = -1 != pa().toLowerCase().indexOf("webkit") && !y("Edge");
function ya() {
  var e = E.document;
...
if (E.document && M) {
  var U = ya();
  F = U || parseInt(D, 10) || void 0;
} else F = void 0;
var K = F;
function A(e, t) {
  if (
    (w.call(this, e ? e.type : ""),
...
function Ra(e, t) {
  ...
  for (let t = 1; t < arguments.length; t++) {
    ...
    for (let t = 0; t < j.length; t++)
      (n = j[t]), Object.prototype.hasOwnProperty.call(i, n) && (e[n] = i[n]);
  }
}
function Sa(e) {
...
function Ua(e, t) {
  ...
  if (n in e.g) {
    ...
    (i = 0 <= o) && Array.prototype.splice.call(s, o, 1),
      i && (Ka(t), 0 == e.g[n].length && (delete e.g[n], e.h--));
  }
}
function Ta(e, t, n, i) {
...
var J = "__closure_events_fn_" + ((1e9 * Math.random()) >>> 0);
function $a(e) {
...
function C$1(e, t) {
  ...
  if (((e = e.S), (i = t.type || t), "string" == typeof t)) t = new w(t, e);
  ...
  (B$1.prototype.N = function () {
    if ((B$1.$.N.call(this), this.i)) {
      var e,
        t = this.i;
      for (e in t.g) {
        for (var n = t.g[e], i = 0; i < n.length; i++) Ka(n[i]);
        delete t.g[e], t.h--;
      }
    }
    this.J = null;
...
function Pb(e, t) {
  w.call(this, ne.STAT_EVENT, e), (this.stat = t);
}
function F$1(e) {
  const t = Mb();
  C$1(t, new Pb(t, e));
...
function Qb(e, t) {
  w.call(this, ne.Ua, e), (this.size = t);
}
function Rb(e, t) {
...
var ue = 45e3,
  ...
  _e = {};
function gc(e, t, n) {
  (e.L = 1), (e.v = hc(G$1(t))), (e.s = n), (e.S = !0), ic(e, null);
}
function ic(e, t) {
  (e.G = Date.now()), jc(e), (e.A = G$1(e.v));
  var n = e.A,
    i = e.W;
  Array.isArray(i) || (i = [String(i)]),
    ...
    (n = e.l.J),
    (e.h = new dc()),
    (e.g = lc(e.l, n ? t : null, !e.s)),
    0 < e.O && (e.M = new Ab(q$1(e.Pa, e, e.g), e.O)),
    Db(e.U, e.g, "readystatechange", e.nb),
    (t = e.I ? Pa(e.I) : {}),
    e.s
      ? (e.u || (e.u = "POST"),
...
function rc(e, t, n) {
  ...
  for (; !e.J && e.C < n.length; ) {
    if (((i = uc(e, n)), i == _e)) {
      4 == t && ((e.o = 4), F$1(14), (s = !1)),
        D$1(e.j, e.m, null, "[Incomplete Response]");
      break;
    }
    if (i == le) {
      (e.o = 4), F$1(15), D$1(e.j, e.m, n, "[Invalid Chunk]"), (s = !1);
      break;
    }
    D$1(e.j, e.m, i, null), qc(e, i);
  }
  oc(e) && i != _e && i != le && ((e.h.g = ""), (e.C = 0)),
    4 != t || 0 != n.length || e.h.h || ((e.o = 1), F$1(16), (s = !1)),
    (e.i = e.i && s),
    s
      ? 0 < n.length &&
        !e.ba &&
          ...
          if (((n.V = h[0]), (h = h[1]), 2 == n.H))
            if ("c" == h[0]) {
              ...
              if ((((i = n).wa = Dc(i, i.J ? i.pa : null, i.Y)), u.K)) {
                ...
                var l = u,
                  _ = i.L;
                _ && l.setTimeout(_), l.B && (nc(l), jc(l)), (i.g = u);
              } else Fc(i);
              0 < n.j.length && Gc(n);
    ...
    try {
      if (e == this.g)
        e: {
          ...
          if (
            !(3 > d) &&
            (3 != d || k || (this.g && (this.h.h || this.g.ja() || mc(this.g))))
          ) {
            ...
            t: if (oc(this)) {
              ...
              i.splice(0, s), (this.h.g += e), (this.C = 0), (u = this.h.g);
            } else u = this.g.ja();
            if (
              ((this.i = 200 == n),
              ...
              })(this.j, this.u, this.A, this.m, this.W, d, n),
              this.i)
            ) {
              if (this.aa && !this.K) {
                t: {
                ...
                if (!(n = h)) {
                  (this.i = !1), (this.o = 3), F$1(12), I(this), pc(this);
                  break e;
                }
                D$1(
                  this.j,
              ...
              this.S
                ? (rc(this, d, u),
                  k &&
                    this.i &&
                    3 == d &&
                    (Db(this.U, this.V, "tick", this.mb), this.V.start()))
...
M$1.prototype.toString = function () {
  ...
  return (
    ...
    (n = this.l) &&
      ...
      e.push(Sc(n, "/" == n.charAt(0) ? fe : me, !0))),
    (n = this.i.toString()) && e.push("?", n),
    (n = this.o) && e.push("#", Sc(n, pe)),
    e.join("")
  );
};
var de = /[#\/\?@]/g,
    ...
    if (e.v && 4 == H$1(e)) yb(e.La, 0, e);
      ...
      try {
        ...
        if (!(n = t)) {
          var i;
          if ((i = 0 === u)) {
            var s = String(e.I).match(he)[1] || null;
            !s &&
              E.self &&
              E.self.location &&
              (s = E.self.location.protocol.slice(0, -1)),
              (i = !Ae.test(s ? s.toLowerCase() : ""));
          }
          n = i;
        }
...
function Gc(e) {
  if (!ed(e.i) && !e.m) {
    e.m = !0;
    var t = e.Na;
    Z || vb(), ee || (Z(), (ee = !0)), te.add(t, e), (e.C = 0);
  }
}
function Ld(e, t) {
  var n;
...
function Fc(e) {
  if (!e.g && !e.u) {
    e.ba = 1;
    var t = e.Ma;
    Z || vb(), ee || (Z(), (ee = !0)), te.add(t, e), (e.A = 0);
  }
}
function Ac(e) {
  return (
...
function Md(e) {
  ...
  var n = e.g;
  (e = e.pa), (n.L = 1), (n.v = hc(G$1(t))), (n.s = null), (n.S = !0), ic(n, e);
}
function yc(e) {
...
function lc(e, t, n) {
  ...
  return (
    (t = n && e.Ha && !e.va ? new P(new ld({ ob: !0 })) : new P(e.va)).Oa(e.J),
    t
  );
}
function Nd() {}
...
((m = P.prototype).Oa = function (e) {
  ...
  (m.ha = function (e, t, n, i) {
    ...
    (t = t ? t.toUpperCase() : "GET"),
      ...
      (this.F = !1),
      (this.h = !0),
      (this.g = this.u ? this.u.g() : ae.g()),
      (this.C = this.u ? Vb(this.u) : Vb(ae)),
      ...
      wd(this),
        0 < this.B &&
          ((this.L = (function xd(e) {
            return M && "number" == typeof e.timeout && void 0 !== e.ontimeout;
          })(this.g))
  ...
  (m.Wa = function (e) {
    if (this.g) {
      ...
      return e && 0 == t.indexOf(e) && (t = t.substring(e.length)), Ee(t);
    }
  }),
  (m.Ia = function () {
    return this.m;
...
function U$1(e) {
  ...
  for (var t = [], n = 1, i = 0; e >= n; i++) (t[i] = (e / n) | 0), (n *= Ve);
  return new T(t, 0);
}
var Ve = 4294967296,
  ve = Td(0),
...
((m = T.prototype).ea = function () {
  ...
  (m.R = function (e) {
    ...
    if (0 > this.X(we) && 0 > e.X(we)) return U$1(this.ea() * e.ea());
...
function __PRIVATE_logDebug(e, ...t) {
  if (Ue.logLevel <= l.DEBUG) {
    const n = t.map(__PRIVATE_argToString);
    Ue.debug(`Firestore (${$e}): ${e}`, ...n);
  }
}
function __PRIVATE_logError(e, ...t) {
  if (Ue.logLevel <= l.ERROR) {
    const n = t.map(__PRIVATE_argToString);
    Ue.error(`Firestore (${$e}): ${e}`, ...n);
  }
}
function __PRIVATE_logWarn(e, ...t) {
  if (Ue.logLevel <= l.WARN) {
    const n = t.map(__PRIVATE_argToString);
    Ue.warn(`Firestore (${$e}): ${e}`, ...n);
  }
}
...
function fail(e = "Unexpected state") {
  const t = `FIRESTORE (${$e}) INTERNAL ASSERTION FAILED: ` + e;
...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== Ke.FAILED_PRECONDITION || e.message !== Qe) throw e;
...
class __PRIVATE_SimpleDbTransaction {
  constructor(e, t) {
    (this.action = e),
      (this.transaction = t),
      (this.aborted = !1),
      (this.m = new __PRIVATE_Deferred()),
      (this.transaction.oncomplete = () => {
        this.m.resolve();
      }),
      (this.transaction.onabort = () => {
        t.error
          ? this.m.reject(new __PRIVATE_IndexedDbTransactionError(e, t.error))
          : this.m.resolve();
      }),
...
class __PRIVATE_SimpleDb {
  constructor(e, t, n) {
    (this.name = e),
      (this.version = t),
      (this.S = n),
      12.2 === __PRIVATE_SimpleDb.D(getUA()) &&
        __PRIVATE_logError(
  ...
  static v() {
    ...
    const e = getUA(),
      t = __PRIVATE_SimpleDb.D(e),
      n = 0 < t && t < 10,
      i = __PRIVATE_SimpleDb.F(e),
      s = 0 < i && i < 4.5;
    return !(
      e.indexOf("MSIE ") > 0 ||
      e.indexOf("Trident/") > 0 ||
  ...
  static C() {
    ...
    return (
      ...
      "YES" === (null === (e = process.env) || void 0 === e ? void 0 : e.M)
    );
  }
  static O(e, t) {
    return e.store(t);
        ...
        (this.db = await new Promise((t, n) => {
          ...
          (i.onsuccess = (e) => {
            ...
            (i.onupgradeneeded = (e) => {
              ...
              this.S.B(t, i.transaction, e.oldVersion, this.version).next(
                () => {
                  __PRIVATE_logDebug(
                    "SimpleDb",
...
class __PRIVATE_IndexedDbTransactionError extends FirestoreError {
  constructor(e, t) {
    super(Ke.UNAVAILABLE, `IndexedDB transaction '${e}' failed: ${t}`),
...
class __PRIVATE_SimpleDbStore {
  ...
  J(e, t) {
    ...
    return this.j(i, (e, t, n) => n.delete());
  }
  Z(e, t) {
    let n;
    t ? (n = e) : ((n = {}), (t = e));
    ...
    return new PersistencePromise((i, s) => {
      (e.onerror = (e) => {
        ...
        (e.onsuccess = (e) => {
          ...
          o.isDone ? i() : null === o.U ? s.continue() : s.continue(o.U);
        });
...
const We = {},
  He = ["prefixPath", "collectionGroup", "readTime", "documentId"],
  Je = ["prefixPath", "collectionGroup", "documentId"],
  Ye = ["collectionGroup", "readTime", "prefixPath", "documentId"],
  Xe = ["canonicalId", "targetId"],
  Ze = ["targetId", "path"],
  et = ["path", "targetId"],
  tt = ["collectionId", "parent"],
  rt = ["indexId", "uid"],
  nt = ["uid", "sequenceNumber"],
  it = [
    "indexId",
    "uid",
    "arrayValue",
  ...
  st = ["indexId", "uid", "orderedDocumentKey"],
  ot = ["userId", "collectionPath", "documentId"],
  at = ["userId", "collectionPath", "largestBatchId"],
  ct = ["userId", "collectionGroup", "largestBatchId"],
  ut = [
    "mutationQueues",
    "mutations",
    "documentMutations",
  ...
  ht = _t,
  dt = [...ht, "indexConfiguration", "indexState", "indexEntries"];
...
const ft = { mapValue: { fields: { __type__: { stringValue: "__max__" } } } },
  ...
  switch (n) {
    ...
    case 10:
      return (function __PRIVATE_compareMaps(e, t) {
        if (e === ft.mapValue && t === ft.mapValue) return 0;
        if (e === ft.mapValue) return 1;
        if (t === ft.mapValue) return -1;
        const n = e.fields || {},
          i = Object.keys(n),
          s = t.fields || {},
          o = Object.keys(s);
...
function __PRIVATE_queryOrderBy(e) {
  ...
  if (null === t.Pe) {
    t.Pe = [];
    const e = __PRIVATE_getInequalityFilterField(t),
      n = __PRIVATE_getFirstOrderByField(t);
    if (null !== e && null === n)
      e.isKeyField() || t.Pe.push(new OrderBy(e)),
        t.Pe.push(new OrderBy(FieldPath$1.keyField(), "asc"));
    else {
      let e = !1;
...
function __PRIVATE_queryToTarget(e) {
  ...
  if (!t.Ie)
    if ("F" === t.limitType)
      t.Ie = __PRIVATE_newTarget(
        t.path,
        t.collectionGroup,
        __PRIVATE_queryOrderBy(t),
        t.filters,
        t.limit,
        t.startAt,
        t.endAt,
      ...
      const e = [];
      for (const n of __PRIVATE_queryOrderBy(t)) {
        const t = "desc" === n.dir ? "asc" : "desc";
        e.push(new OrderBy(n.field, t));
      }
      const n = t.endAt ? new Bound(t.endAt.position, t.endAt.inclusive) : null,
        i = t.startAt
          ? new Bound(t.startAt.position, t.startAt.inclusive)
          : null;
      t.Ie = __PRIVATE_newTarget(
        t.path,
        t.collectionGroup,
...
function __PRIVATE_queryMatches(e, t) {
  return (
    ...
    (function __PRIVATE_queryMatchesOrderBy(e, t) {
      for (const n of __PRIVATE_queryOrderBy(e))
    ...
    (function __PRIVATE_queryMatchesBounds(e, t) {
      return (
        !(
          ...
          })(e.startAt, __PRIVATE_queryOrderBy(e), t)
        ) &&
        !(
          e.endAt &&
          !(function __PRIVATE_boundSortsAfterDocument(e, t, n) {
            const i = __PRIVATE_boundCompareToDocument(e, t, n);
            return e.inclusive ? i >= 0 : i > 0;
          })(e.endAt, __PRIVATE_queryOrderBy(e), t)
        )
      );
    })(e, t)
  );
...
function __PRIVATE_newQueryComparator(e) {
  return (t, n) => {
    let i = !1;
    for (const s of __PRIVATE_queryOrderBy(e)) {
...
const Tt = new SortedMap(DocumentKey.comparator),
  Et = new SortedSet(DocumentKey.comparator);
function __PRIVATE_documentKeySet(...e) {
  let t = Et;
  for (const n of e) t = t.add(n);
  return t;
}
const Pt = new SortedSet(__PRIVATE_primitiveComparator);
  ...
  return e instanceof __PRIVATE_ServerTimestampTransform
    ...
    : (function __PRIVATE_applyNumericIncrementTransformOperationToLocalView(
        ...
        const n = __PRIVATE_computeTransformOperationBaseValue(e, t),
          i = asNumber(n) + asNumber(e.Te);
        return isInteger(n) && isInteger(e.Te)
              ...
              return (
                ...
                (function __PRIVATE_transformOperationEquals(e, t) {
                  return (e instanceof __PRIVATE_ArrayUnionTransformOperation &&
                    ...
                    ? __PRIVATE_valueEquals(e.Te, t.Te)
...
function __PRIVATE_mapCodeFromRpcCode(e) {
  if (void 0 === e)
    return __PRIVATE_logError("GRPC error has no .code"), Ke.UNKNOWN;
  switch (e) {
    case At.OK:
      return Ke.OK;
    case At.CANCELLED:
    ...
    case At.DEADLINE_EXCEEDED:
      return Ke.DEADLINE_EXCEEDED;
    case At.RESOURCE_EXHAUSTED:
      return Ke.RESOURCE_EXHAUSTED;
    case At.INTERNAL:
      return Ke.INTERNAL;
    case At.UNAVAILABLE:
      return Ke.UNAVAILABLE;
    case At.UNAUTHENTICATED:
      return Ke.UNAUTHENTICATED;
    case At.INVALID_ARGUMENT:
      return Ke.INVALID_ARGUMENT;
    case At.NOT_FOUND:
      return Ke.NOT_FOUND;
    case At.ALREADY_EXISTS:
      return Ke.ALREADY_EXISTS;
    case At.PERMISSION_DENIED:
      return Ke.PERMISSION_DENIED;
    case At.FAILED_PRECONDITION:
      return Ke.FAILED_PRECONDITION;
    case At.ABORTED:
      return Ke.ABORTED;
    case At.OUT_OF_RANGE:
      return Ke.OUT_OF_RANGE;
    case At.UNIMPLEMENTED:
      return Ke.UNIMPLEMENTED;
    case At.DATA_LOSS:
      return Ke.DATA_LOSS;
    default:
      return fail();
...
((Rt = At || (At = {}))[(Rt.OK = 0)] = "OK"),
  (Rt[(Rt.CANCELLED = 1)] = "CANCELLED"),
  (Rt[(Rt.UNKNOWN = 2)] = "UNKNOWN"),
  (Rt[(Rt.INVALID_ARGUMENT = 3)] = "INVALID_ARGUMENT"),
  (Rt[(Rt.DEADLINE_EXCEEDED = 4)] = "DEADLINE_EXCEEDED"),
  (Rt[(Rt.NOT_FOUND = 5)] = "NOT_FOUND"),
  (Rt[(Rt.ALREADY_EXISTS = 6)] = "ALREADY_EXISTS"),
  (Rt[(Rt.PERMISSION_DENIED = 7)] = "PERMISSION_DENIED"),
  (Rt[(Rt.UNAUTHENTICATED = 16)] = "UNAUTHENTICATED"),
  (Rt[(Rt.RESOURCE_EXHAUSTED = 8)] = "RESOURCE_EXHAUSTED"),
  (Rt[(Rt.FAILED_PRECONDITION = 9)] = "FAILED_PRECONDITION"),
  (Rt[(Rt.ABORTED = 10)] = "ABORTED"),
  (Rt[(Rt.OUT_OF_RANGE = 11)] = "OUT_OF_RANGE"),
  (Rt[(Rt.UNIMPLEMENTED = 12)] = "UNIMPLEMENTED"),
  (Rt[(Rt.INTERNAL = 13)] = "INTERNAL"),
  (Rt[(Rt.UNAVAILABLE = 14)] = "UNAVAILABLE"),
  (Rt[(Rt.DATA_LOSS = 15)] = "DATA_LOSS");
class __PRIVATE_TestingHooks {
  ...
  static getOrCreateInstance() {
    return null === yt && (yt = new __PRIVATE_TestingHooks()), yt;
  }
...
const Vt = new Be([4294967295, 4294967295], 0);
...
function __PRIVATE_get64BitUints(e) {
  const t = new DataView(e.buffer),
    ...
    s = t.getUint32(8, !0),
    o = t.getUint32(12, !0);
  return [new Be([n, i], 0), new Be([s, o], 0)];
}
class BloomFilter {
  constructor(e, t, n) {
    if (
    ...
    (this.de = 8 * e.length - t), (this.Ae = Be.fromNumber(this.de));
  }
  Re(e, t, n) {
    let i = e.add(t.multiply(Be.fromNumber(n)));
    return (
      1 === i.compare(Vt) && (i = new Be([i.getBits(0), i.getBits(1)], 0)),
      i.modulo(this.Ae).toNumber()
    );
  }
  Ve(e) {
...
class __PRIVATE_DocumentWatchChange {
  constructor(e, t, n, i) {
    (this.fe = e), (this.removedTargetIds = t), (this.key = n), (this.ge = i);
  }
}
...
class __PRIVATE_TargetState {
  constructor() {
    (this.ye = 0),
      ...
      (this.Se = ByteString.EMPTY_BYTE_STRING),
      (this.be = !1),
      (this.De = !0);
  }
  get current() {
...
class __PRIVATE_WatchChangeAggregator {
  ...
  Ze(e) {
    ...
    if (o) {
      const u = o.target;
      if (__PRIVATE_targetIsDocumentTarget(u))
        if (0 === s) {
          const e = new DocumentKey(u.path);
          this.ze(
            i,
            e,
            MutableDocument.newNoDocument(e, SnapshotVersion.min()),
          );
        } else __PRIVATE_hardAssert(1 === s);
      else {
        const o = this.et(i);
        if (o !== s) {
          const s = this.tt(e, o);
          if (0 !== s.status) {
            ...
            this.Ue = this.Ue.insert(i, e);
          }
          null === (t = __PRIVATE_TestingHooks.instance) ||
            void 0 === t ||
            t.notifyOnExistenceFilterMismatch(
              (function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(
                ...
                var s, o, u, l, _, h;
                const d = { localCacheCount: n, existenceFilterCount: i.count },
                  m = i.unchangedNames;
                return (
                  m &&
                    ((d.bloomFilter = {
                      applied: 0 === e,
                      hashCount:
                        null !== (s = null == m ? void 0 : m.hashCount) &&
                        void 0 !== s
                          ? s
                          : 0,
                      bitmapLength:
                    ...
                    t && (d.bloomFilter.mightContain = t)),
                  d
                );
              })(
                s.status,
                null !== (n = s.nt) && void 0 !== n ? n : null,
                o,
                e.pe,
              ),
            );
  ...
  tt(e, t) {
    const { unchangedNames: n, count: i } = e.pe;
    ...
    let l, _;
    try {
      l = __PRIVATE_normalizeByteString(s).toUint8Array();
    } catch (e) {
    ...
    return 0 === _.de
      ...
      : {
          status:
            i === t - this.it(e.targetId, __PRIVATE_bloomFilterMightContain)
              ? 0
              : 2,
  ...
  it(e, t) {
    ...
    return (
      n.forEach((n) => {
        t(n.path.canonicalString()) || (this.ze(e, n, null), i++);
      }),
      i
    );
  }
  st(e) {
    ...
    this.Qe.forEach((n, i) => {
      ...
      if (s) {
        if (n.current && __PRIVATE_targetIsDocumentTarget(s.target)) {
          ...
          null !== this.Ke.get(t) ||
            this.ot(i, t) ||
            this.ze(i, t, MutableDocument.newNoDocument(t, e));
        }
        n.Ce && (t.set(i, n.Me()), n.xe());
      }
    });
    ...
    const i = new RemoteEvent(e, t, this.Ue, this.Ke, n);
    return (
      (this.Ke = __PRIVATE_mutableDocumentMap()),
      (this.$e = __PRIVATE_documentTargetMap()),
      (this.Ue = new SortedMap(__PRIVATE_primitiveComparator)),
      ...
      (n.updateTransforms = t.fieldTransforms.map((e) =>
        (function __PRIVATE_toFieldTransform(e, t) {
          ...
          if (n instanceof __PRIVATE_NumericIncrementTransformOperation)
            return { fieldPath: t.field.canonicalString(), increment: n.Te };
          throw fail();
        })(0, e),
      )),
          ...
          return (
            ...
            __PRIVATE_queryToTarget(
              __PRIVATE_newQueryForPath(
                __PRIVATE_fromQueryPath(e.documents[0]),
              ),
            )
          );
        })(e.query)
...
function __PRIVATE_toDbTarget(e, t) {
  ...
  s = __PRIVATE_targetIsDocumentTarget(t.target)
    ? __PRIVATE_toDocumentsTarget(e.ct, t.target)
    : __PRIVATE_toQueryTarget(e.ct, t.target);
...
function __PRIVATE_fromDbDocumentOverlay(e, t) {
  return new Overlay(
    t.largestBatchId,
    __PRIVATE_fromMutation(e.ct, t.overlayMutation),
  );
}
...
class __PRIVATE_IndexedDbDocumentOverlayCache {
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    return (
      i.forEach((t) => {
        ...
        s.push(
          __PRIVATE_documentOverlayStore(e).J("collectionPathOverlayIndex", i),
        );
      }),
  ...
  getOverlaysForCollection(e, t, n) {
    ...
    return __PRIVATE_documentOverlayStore(e)
      .G("collectionPathOverlayIndex", o)
      .next((e) => {
        for (const t of e) {
  ...
  getOverlaysForCollectionGroup(e, t, n, i) {
    ...
    return __PRIVATE_documentOverlayStore(e)
      .Z({ index: "collectionGroupOverlayIndex", range: u }, (e, t, n) => {
...
class __PRIVATE_FirestoreIndexValueWriter {
  ...
  It(e, t) {
    if ("nullValue" in e) this.Et(t, 5);
      ...
      isNaN(n)
        ? this.Et(t, 13)
        : (this.Et(t, 15), __PRIVATE_isNegativeZero(n) ? t.dt(0) : t.dt(n));
      ...
      this.Et(t, 30),
        t.ft(__PRIVATE_normalizeByteString(e.bytesValue)),
        this.Vt(t);
...
__PRIVATE_FirestoreIndexValueWriter.bt =
...
class __PRIVATE_OrderedCodeWriter {
  ...
  Ot(e) {
    for (const t of e) {
      ...
      if (e < 128) this.vt(e);
      else if (e < 2048) this.vt(960 | (e >>> 6)), this.vt(128 | (63 & e));
      else if (t < "\ud800" || "\udbff" < t)
        this.vt(480 | (e >>> 12)),
          this.vt(128 | (63 & (e >>> 6))),
          this.vt(128 | (63 & e));
...
class __PRIVATE_IndexByteEncoder {
  constructor() {
    (this.Gt = new __PRIVATE_OrderedCodeWriter()),
      (this.zt = new __PRIVATE_AscendingIndexByteEncoder(this.Gt)),
...
class __PRIVATE_TargetIndexMatcher {
  ...
  en(e) {
    ...
    if (void 0 !== this.Xt) {
      if (!i.has(this.Xt.field.canonicalString())) {
        const e = n[s];
        if (!this.nn(this.Xt, e) || !this.rn(this.Yt[o++], e)) return !1;
      }
      ++s;
    }
    for (; s < n.length; ++s) {
...
class __PRIVATE_IndexedDbIndexManager {
  ...
  getDocumentsMatchingTarget(e, t) {
    ...
    let i = !0;
    const s = new Map();
    return PersistencePromise.forEach(this.an(t), (t) =>
      this.un(e, t).next((e) => {
        i && (i = !!e), s.set(t, e);
      }),
    ).next(() => {
      if (i) {
        ...
        return PersistencePromise.forEach(s, (s, o) => {
          ...
          const u = (function __PRIVATE_targetGetArrayValues(e, t) {
            ...
            m = this.cn(s, o, h),
            f = this.ln(s, o, l),
            g = this.hn(s.indexId, u, d, _.inclusive, m, h.inclusive, f);
          return PersistencePromise.forEach(g, (s) =>
            n.H(s, t.limit).next((t) => {
              t.forEach((t) => {
  ...
  hn(e, t, n, i, s, o, u) {
    const l = (null != t ? t.length : 1) * Math.max(n.length, s.length),
      ...
      h = [];
    for (let d = 0; d < l; ++d) {
      const l = t ? this.Pn(t[d / _]) : wt,
        m = this.In(e, l, n[d % _], i),
        f = this.Tn(e, l, s[d % _], o),
        g = u.map((t) => this.In(e, l, t, !0));
  ...
  dn(e, t) {
    const n = new __PRIVATE_IndexByteEncoder();
    return (
      __PRIVATE_FirestoreIndexValueWriter.bt.Pt(
  ...
  ln(e, t, n) {
    ...
    for (const o of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e = n[s++];
      for (const n of i)
        if (this.An(t, o.fieldPath) && isArray(e)) i = this.Rn(i, o, e);
        else {
          const t = n.Ht(o.kind);
  ...
  Rn(e, t, n) {
    ...
    for (const e of n.arrayValue.values || [])
      for (const n of i) {
        ...
        i.seed(n.Wt()),
          __PRIVATE_FirestoreIndexValueWriter.bt.Pt(e, i.Ht(t.kind)),
          s.push(i);
      }
    return s;
  }
    ...
    if (null != s) {
      ...
      if (isArray(o))
        for (const s of o.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Pn(s), i));
    } else n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, wt, i));
    return n;
  }
  pn(e, t, n, i, s) {
    __PRIVATE_logDebug(
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.an(t), (t) =>
      this.un(e, t).next((e) => e || fail()),
...
function removeMutationBatch(e, t, n) {
  ...
  let l = 0;
  const _ = i.Z({ range: u }, (e, t, n) => (l++, n.delete()));
  o.push(
    _.next(() => {
...
class __PRIVATE_IndexedDbMutationQueue {
  ...
  checkEmpty(e) {
    ...
    return __PRIVATE_mutationsStore(e)
      .Z({ index: "userMutationsIndex", range: n }, (e, n, i) => {
        (t = !1), i.done();
      })
      .next(() => t);
  }
  ...
  Dn(e, t) {
    return this.bn[t]
      ? PersistencePromise.resolve(this.bn[t])
  ...
  getNextMutationBatchAfterBatchId(e, t) {
    ...
    let s = null;
    return __PRIVATE_mutationsStore(e)
      .Z({ index: "userMutationsIndex", range: i }, (e, t, i) => {
  ...
  getHighestUnacknowledgedBatchId(e) {
    ...
    let n = -1;
    return __PRIVATE_mutationsStore(e)
      .Z({ index: "userMutationsIndex", range: t, reverse: !0 }, (e, t, i) => {
        (n = t.batchId), i.done();
      })
      .next(() => n);
  }
    ...
    return (
      t.forEach((t) => {
        const s = __PRIVATE_newDbDocumentMutationPrefixForPath(
          ...
          u = __PRIVATE_documentMutationsStore(e).Z({ range: o }, (e, i, s) => {
            const [o, u, l] = e,
  ...
  removeMutationBatch(e, t) {
    return removeMutationBatch(e.ue, this.userId, t).next(
      (n) => (
        e.addOnCommittedListener(() => {
          this.Cn(t.batchId);
        }),
...
class __PRIVATE_IndexedDbTargetCache {
  ...
  getTargetData(e, t) {
    ...
    let s = null;
    return __PRIVATE_targetsStore(e)
      .Z({ range: i, index: "queryTargetsIndex" }, (e, n, i) => {
  ...
  containsKey(e, t) {
    ...
    return __PRIVATE_documentTargetStore(e)
      .Z({ index: "documentTargetsIndex", Y: !0, range: i }, ([e, t], n, i) => {
        0 !== e && (s++, i.done());
      })
      .next(() => s > 0);
  }
...
class __PRIVATE_IndexedDbLruDelegateImpl {
  ...
  removeOrphanedDocuments(e, t) {
    const n = this.db.getRemoteDocumentCache().newChangeBuffer(),
      i = [];
    let s = 0;
    return this.Yn(e, (o, u) => {
      if (u <= t) {
        const t = this.Zn(e, o).next((t) => {
          if (!t)
            return (
              s++,
              n.getEntry(e, o).next(
...
class __PRIVATE_IndexedDbRemoteDocumentCacheImpl {
  ...
  tr(e, t) {
    ...
    return __PRIVATE_remoteDocumentsStore(e)
      .Z(
        ...
        (e, i) => {
          n = { document: this.er(t, i), size: __PRIVATE_dbDocumentSize(i) };
        },
      )
      .next(() => n);
  }
  ...
  nr(e, t, n) {
    ...
    let u = o.getNext();
    return __PRIVATE_remoteDocumentsStore(e)
      .Z({ index: "documentKeyIndex", range: s }, (e, t, i) => {
        ...
        u && u.isEqual(s) && (n(u, t), (u = o.hasNext() ? o.getNext() : null)),
          u ? i.W(__PRIVATE_dbKey(u)) : i.done();
      })
      .next(() => {
...
class __PRIVATE_IndexedDbRemoteDocumentChangeBuffer extends RemoteDocumentChangeBuffer {
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((s, o) => {
        const u = this._r.get(s);
        if (
          (t.push(this.sr.removeEntry(e, s, u.readTime)), o.isValidDocument())
        ) {
          const l = __PRIVATE_toDbRemoteDocument(this.sr.serializer, o);
          i = i.add(s.path.popLast());
          const _ = __PRIVATE_dbDocumentSize(l);
          (n += _ - u.size), t.push(this.sr.addEntry(e, s, l));
        } else if (((n -= u.size), this.trackRemovals)) {
          const n = __PRIVATE_toDbRemoteDocument(
            this.sr.serializer,
            o.convertToNoDocument(SnapshotVersion.min()),
          );
          t.push(this.sr.addEntry(e, s, n));
        }
      }),
      i.forEach((n) => {
  ...
  getFromCache(e, t) {
    return this.sr
      ...
      .next(
        (e) => (
          this._r.set(t, { size: e.size, readTime: e.document.readTime }),
          e.document
        ),
      );
  }
  ...
  getDocumentsMatchingCollectionGroupQuery(e, t, n) {
    ...
    return this.indexManager.getCollectionParents(e, i).next((o) =>
      PersistencePromise.forEach(o, (o) => {
        const u = (function __PRIVATE_asCollectionQueryAtPath(e, t) {
          return new __PRIVATE_QueryImpl(
            t,
            null,
            e.explicitOrderBy.slice(),
        ...
        return this.getDocumentsMatchingCollectionQuery(e, u, n).next((e) => {
          e.forEach((e, t) => {
            s = s.insert(e, t);
          });
        });
  ...
  getDocumentsMatchingCollectionQuery(e, t, n) {
    ...
    return this.documentOverlayCache
      ...
      .next(
        (s) => (
          (i = s),
          this.remoteDocumentCache.getDocumentsMatchingQuery(e, t, n, i)
        ),
      )
      .next((e) => {
        i.forEach((t, n) => {
        ...
        return (
          e.forEach((e, s) => {
            ...
            void 0 !== o &&
              ...
              __PRIVATE_queryMatches(t, s) && (n = n.insert(e, s));
          }),
          n
        );
      });
...
class __PRIVATE_MemoryDocumentOverlayCache {
  ...
  ht(e, t, n) {
    ...
    if (null !== i) {
      const e = this.cr.get(i.largestBatchId).delete(n.key);
      this.cr.set(i.largestBatchId, e);
    }
    this.overlays = this.overlays.insert(n.key, new Overlay(t, n));
    let s = this.cr.get(t);
    void 0 === s && ((s = __PRIVATE_documentKeySet()), this.cr.set(t, s)),
      this.cr.set(t, s.add(n.key));
  }
}
class __PRIVATE_ReferenceSet {
  constructor() {
    (this.lr = new SortedSet(__PRIVATE_DocReference.hr)),
  ...
  Ar(e) {
    const t = new DocumentKey(new ResourcePath([])),
      ...
      s = [];
    return (
      this.Pr.forEachInRange([n, i], (e) => {
        this.Er(e), s.push(e.key);
      }),
      s
    );
  }
...
class __PRIVATE_DocReference {
  ...
  static hr(e, t) {
    return (
      ...
      __PRIVATE_primitiveComparator(e.mr, t.mr)
    );
  }
  static Ir(e, t) {
    return (
...
class __PRIVATE_MemoryMutationQueue {
  ...
  addMutationBatch(e, t, n, i) {
    ...
    for (const t of i)
      (this.pr = this.pr.add(new __PRIVATE_DocReference(t.key, s))),
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return (
      this.pr.forEachWhile((e) => {
        const t = e.key.path;
        return !!n.isPrefixOf(t) && (t.length === i && (u = u.add(e.mr)), !0);
      }, o),
      PersistencePromise.resolve(this.Sr(u))
    );
  }
  Sr(e) {
    const t = [];
  ...
  removeMutationBatch(e, t) {
    __PRIVATE_hardAssert(0 === this.br(t.batchId, "removed")),
...
class __PRIVATE_MemoryTargetCache {
  constructor(e) {
    (this.persistence = e),
      ...
      (this.Fr = 0),
      (this.Mr = new __PRIVATE_ReferenceSet()),
      (this.targetCount = 0),
      (this.Or = __PRIVATE_TargetIdGenerator.xn());
  }
  forEachTarget(e, t) {
    return this.Cr.forEach((e, n) => t(n)), PersistencePromise.resolve();
  }
  getLastRemoteSnapshotVersion(e) {
  ...
  Ln(e) {
    ...
    t > this.highestTargetId &&
      ((this.Or = new __PRIVATE_TargetIdGenerator(t)),
...
class __PRIVATE_MemoryPersistence {
  constructor(e, t) {
    (this.Nr = {}),
      (this.overlays = {}),
      (this.Br = new __PRIVATE_ListenSequence(0)),
      (this.Lr = !1),
      (this.Lr = !0),
      (this.referenceDelegate = e(this)),
      (this.kr = new __PRIVATE_MemoryTargetCache(this)),
      ...
      (this.Qr = new __PRIVATE_MemoryBundleCache(this.serializer));
  }
  start() {
    return Promise.resolve();
  }
  ...
  runTransaction(e, t, n) {
    ...
    const i = new __PRIVATE_MemoryTransaction(this.Br.next());
    return (
      this.referenceDelegate.Kr(),
      n(i)
        .next((e) => this.referenceDelegate.$r(i).next(() => e))
        .toPromise()
...
class __PRIVATE_MemoryEagerDelegate {
  constructor(e) {
    (this.persistence = e),
      (this.Wr = new __PRIVATE_ReferenceSet()),
      (this.Gr = null);
  }
  static zr(e) {
  ...
  Hr(e, t) {
    return PersistencePromise.or([
      () => PersistencePromise.resolve(this.Wr.containsKey(t)),
...
class __PRIVATE_MemoryLruDelegate {
  ...
  jn(e, t) {
    return PersistencePromise.forEach(this.Jr, (n, i) =>
      this.Zn(e, n, i).next((e) => (e ? PersistencePromise.resolve() : t(i))),
    );
  }
  removeTargets(e, t, n) {
  ...
  markPotentiallyOrphaned(e, t) {
    return (
      this.Jr.set(t, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return (
      this.Jr.set(n, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeReference(e, t, n) {
    return (
...
class __PRIVATE_SchemaConverter {
  ...
  B(e, t, n, i) {
      ...
      (function __PRIVATE_createMutationQueue(e) {
        e.createObjectStore("mutationQueues", { keyPath: "userId" }),
          e
            ...
            .createIndex("userMutationsIndex", je, { unique: !0 }),
    ...
    return (
      ...
      n < 7 && i >= 7 && (o = o.next(() => this.Xr(s))),
      n < 8 && i >= 8 && (o = o.next(() => this.ei(e, s))),
      n < 9 &&
        i >= 9 &&
        (o = o.next(() => {
      ...
      n < 12 &&
        ...
        (o = o.next(() => {
          !(function __PRIVATE_createDocumentOverlayStore(e) {
            const t = e.createObjectStore("documentOverlays", { keyPath: ot });
            t.createIndex("collectionPathOverlayIndex", at, { unique: !1 }),
              t.createIndex("collectionGroupOverlayIndex", ct, { unique: !1 });
          })(e);
        })),
      n < 13 &&
        i >= 13 &&
          ...
          .next(() =>
            (function __PRIVATE_createRemoteDocumentCache(e) {
              ...
              t.createIndex("documentKeyIndex", Je),
                t.createIndex("collectionGroupIndex", Ye);
            })(e),
          )
          .next(() => this.ni(e, s))
          .next(() => e.deleteObjectStore("remoteDocuments"))),
      n < 14 && i >= 14 && (o = o.next(() => this.ri(e, s))),
      n < 15 &&
        i >= 15 &&
        (o = o.next(() =>
          (function __PRIVATE_createFieldIndex(e) {
            e
              ...
              e
                .createObjectStore("indexState", { keyPath: rt })
                .createIndex("sequenceNumberIndex", nt, { unique: !1 }),
              e
                .createObjectStore("indexEntries", { keyPath: it })
                .createIndex("documentKeyIndex", st, { unique: !1 });
          })(e),
        )),
      o
    );
  ...
  Yr(e) {
    ...
    return t.G().next((t) =>
      PersistencePromise.forEach(t, (t) => {
        ...
        return n.G("userMutationsIndex", i).next((n) =>
  ...
  ei(e, t) {
    e.createObjectStore("collectionParents", { keyPath: tt });
    ...
    return t
      ...
      .next(() =>
        t.store("documentMutations").Z({ Y: !0 }, ([e, t, n], i) => {
      ...
      return (
        ...
        PersistencePromise.forEach(n, (e, n) => {
          const o = new User(n),
            ...
            _ = __PRIVATE_IndexedDbMutationQueue.lt(
              o,
              this.serializer,
              l,
              s.referenceDelegate,
...
function __PRIVATE_createQueryCache(e) {
  e
    .createObjectStore("targetDocuments", { keyPath: Ze })
    .createIndex("documentTargetsIndex", et, { unique: !0 }),
    e
      .createObjectStore("targets", { keyPath: "targetId" })
      .createIndex("queryTargetsIndex", Xe, { unique: !0 }),
...
class __PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, i, s, o, u, l, _, h, d = 15) {
    if (
      ...
      !__PRIVATE_IndexedDbPersistence.v())
    )
      throw new FirestoreError(
        Ke.UNIMPLEMENTED,
    ...
    (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, i)),
      ...
      (this.kr = new __PRIVATE_IndexedDbTargetCache(
      ...
      (this.Qr = new __PRIVATE_IndexedDbBundleCache()),
    ...
    return this.Ei()
      .then(() => {
        if (!this.isPrimary && !this.allowTabSynchronization)
          throw new FirestoreError(Ke.FAILED_PRECONDITION, Ct);
        return (
          this.di(),
          this.Ai(),
          this.Ri(),
  ...
  Ei() {
    return this.runTransaction(
      ...
      .then((e) => {
        this.isPrimary !== e && this.ii.enqueueRetryable(() => this.hi(e)),
          (this.isPrimary = e);
      });
  }
  mi(e) {
    return __PRIVATE_primaryClientStore(e)
      .get("owner")
      .next((e) => PersistencePromise.resolve(this.yi(e)));
  }
  wi(e) {
  ...
  async Si() {
    if (this.isPrimary && !this.bi(this.li, 18e5)) {
      ...
      if (this.Ti) for (const t of e) this.Ti.removeItem(this.vi(t.clientId));
    }
  }
  Ri() {
    this.ci = this.ii.enqueueAfterDelay("client_metadata_refresh", 4e3, () =>
      this.Ei()
        .then(() => this.Si())
        .then(() => this.Ri()),
    );
  ...
  Di(e, t) {
    return e.filter((e) => this.bi(e.updateTimeMs, t) && !this.Ci(e.clientId));
  }
  Ni() {
  ...
  getMutationQueue(e, t) {
    return __PRIVATE_IndexedDbMutationQueue.lt(
      e,
      this.serializer,
      t,
      this.referenceDelegate,
    ...
    return this.Ii.runTransaction(
      ...
      (i) => (
        (o = new __PRIVATE_IndexedDbTransaction(
          i,
          this.Br ? this.Br.next() : __PRIVATE_ListenSequence.ae,
        )),
        "readwrite-primary" === t
          ? this.mi(o)
              .next((e) => !!e || this.fi(o))
              .next((t) => {
                if (!t)
                  throw (
                    ...
                    (this.isPrimary = !1),
                    this.ii.enqueueRetryable(() => this.hi(!1)),
                    new FirestoreError(Ke.FAILED_PRECONDITION, Qe))
                  );
                return n(o);
              })
              .next((e) => this.pi(o).next(() => e))
          : this.Bi(o).next(() => n(o))
      ),
  ...
  xi() {
    this.ai &&
      (this.window.removeEventListener("pagehide", this.ai), (this.ai = null));
  }
  Ci(e) {
    var t;
    try {
...
class __PRIVATE_LocalViewChanges {
  constructor(e, t, n, i) {
    (this.targetId = e), (this.fromCache = t), (this.Li = n), (this.ki = i);
  }
  static qi(e, t) {
    let n = __PRIVATE_documentKeySet(),
...
class __PRIVATE_QueryEngine {
      ...
      0 === i
        ...
        : (null !== t.limit &&
          ...
          this.indexManager.getDocumentsMatchingTarget(e, n).next((i) => {
            ...
            return this.Ki.getDocuments(e, s).next((i) =>
              this.indexManager.getMinOffset(e, n).next((n) => {
                const o = this.Gi(t, i);
                return this.zi(t, o, s, n.readTime)
                  ? this.$i(e, __PRIVATE_queryWithLimit(t, null, "F"))
                  : this.ji(e, o, t, n);
              }),
            );
          })),
  ...
  Ui(e, t, n, i) {
    return __PRIVATE_queryMatchesAllDocuments(t) ||
      ...
      ? this.Wi(e, t)
      : this.Ki.getDocuments(e, n).next((s) => {
          const o = this.Gi(t, s);
  ...
  Wi(e, t) {
    return (
      ...
      this.Ki.getDocumentsMatchingQuery(e, t, IndexOffset.min())
    );
  }
  ji(e, t, n, i) {
    return this.Ki.getDocumentsMatchingQuery(e, n, i).next(
      (e) => (
        t.forEach((t) => {
          e = e.insert(t.key, t);
        }),
...
class __PRIVATE_LocalStoreImpl {
  constructor(e, t, n, i) {
    (this.persistence = e),
      (this.Hi = t),
      (this.serializer = i),
      (this.Ji = new SortedMap(__PRIVATE_primitiveComparator)),
  ...
  return await n.persistence.runTransaction(
    ...
    (e) => {
      ...
      return n.mutationQueue
        .getAllMutationBatches(e)
        .next(
          (s) => ((i = s), n.es(t), n.mutationQueue.getAllMutationBatches(e)),
        )
        .next((t) => {
          const s = [],
            o = [];
          ...
          return n.localDocuments
            .getDocuments(e, u)
            .next((e) => ({ ts: e, removedBatchIds: s, addedBatchIds: o }));
        });
    },
  );
}
            ...
            : n.kr
                ...
                .next(
                  (s) => (
                    ...
                    n.kr.addTargetData(e, i).next(() => i)
                  ),
                ),
        );
    })
    .then((e) => {
      const i = n.Ji.get(e.targetId);
      return (
        (null === i || e.snapshotVersion.compareTo(i.snapshotVersion) > 0) &&
          ((n.Ji = n.Ji.insert(e.targetId, e)), n.Yi.set(t, e.targetId)),
        e
      );
    });
}
async function __PRIVATE_localStoreReleaseTarget(e, t, n) {
  ...
  (i.Ji = i.Ji.remove(t)), i.Yi.delete(s.target);
}
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  const i = __PRIVATE_debugCast(e);
  let s = SnapshotVersion.min(),
    o = __PRIVATE_documentKeySet();
  return i.persistence.runTransaction("Execute query", "readonly", (e) =>
    (function __PRIVATE_localStoreGetTargetData(e, t, n) {
      const i = __PRIVATE_debugCast(e),
        s = i.Yi.get(n);
      return void 0 !== s
        ? PersistencePromise.resolve(i.Ji.get(s))
        : i.kr.getTargetData(t, n);
    })(i, e, __PRIVATE_queryToTarget(t))
      .next((t) => {
        if (t)
          return (
            (s = t.lastLimboFreeSnapshotVersion),
            i.kr.getMatchingKeysForTargetId(e, t.targetId).next((e) => {
              o = e;
            })
          );
      })
      .next(() =>
        i.Hi.getDocumentsMatchingQuery(
          e,
          t,
...
function __PRIVATE_setMaxReadTime(e, t, n) {
  let i = e.Zi.get(t) || SnapshotVersion.min();
  n.forEach((e, t) => {
...
async function __PRIVATE_localStoreSaveNamedQuery(
  ...
  return s.persistence.runTransaction("Save named query", "readwrite", (e) => {
    ...
    if (i.snapshotVersion.compareTo(o) >= 0) return s.Qr.saveNamedQuery(e, t);
    const u = i.withResumeToken(ByteString.EMPTY_BYTE_STRING, o);
    return (
      (s.Ji = s.Ji.insert(u.targetId, u)),
      s.kr
        .updateTargetData(e, u)
        .next(() => s.kr.removeMatchingKeysForTargetId(e, i.targetId))
        .next(() => s.kr.addMatchingKeys(e, n, i.targetId))
        .next(() => s.Qr.saveNamedQuery(e, t))
    );
  });
}
...
class __PRIVATE_WebStorageSharedClientState {
  constructor(e, t, n, i, s) {
    (this.window = e),
      ...
      (this.ds = new SortedMap(__PRIVATE_primitiveComparator)),
      (this.started = !1),
      (this.As = []);
    const o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    (this.storage = this.window.localStorage),
      (this.currentUser = s),
      (this.Rs = createWebStorageClientStateKey(this.persistenceKey, this.Is)),
      (this.Vs = (function createWebStorageSequenceNumberKey(e) {
        return `firestore_sequence_number_${e}`;
      })(this.persistenceKey)),
      (this.ds = this.ds.insert(this.Is, new __PRIVATE_LocalClientState())),
      (this.fs = new RegExp(`^firestore_clients_${o}_([^_]*)$`)),
      (this.gs = new RegExp(`^firestore_mutations_${o}_(\\d+)(?:_(.*))?$`)),
      (this.ps = new RegExp(`^firestore_targets_${o}_(\\d+)$`)),
      (this.ys = (function createWebStorageOnlineStateKey(e) {
        return `firestore_online_state_${e}`;
      })(this.persistenceKey)),
      (this.ws = (function createBundleLoadedKey(e) {
  ...
  async start() {
    ...
    for (const t of e) {
      ...
      if (e) {
        const n = __PRIVATE_RemoteClientState.cs(t, e);
  ...
  addLocalQueryTarget(e) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (n) {
        const i = __PRIVATE_QueryTargetMetadata.cs(e, n);
        i && (t = i.state);
      }
    }
  ...
  qs(e, t) {
    ...
    return __PRIVATE_MutationMetadata.cs(new User(s), i, t);
  }
  Ks(e, t) {
    const n = this.ps.exec(e),
      i = Number(n[1]);
    return __PRIVATE_QueryTargetMetadata.cs(i, t);
  }
  bs(e) {
...
class __PRIVATE_MemorySharedClientState {
  constructor() {
    (this.Hs = new __PRIVATE_LocalClientState()),
      (this.Js = {}),
      (this.onlineStateHandler = null),
      (this.sequenceNumberHandler = null);
  }
...
function __PRIVATE_generateUniqueDebugId() {
  return (
    null === Ft
      ? (Ft = (function __PRIVATE_generateInitialUniqueDebugId() {
          ...
          try {
            switch (l.getLastErrorCode()) {
              case De.NO_ERROR:
                ...
                break;
              case De.TIMEOUT:
                __PRIVATE_logDebug(Mt, `RPC '${e}' ${s} timed out`),
                  u(
                    new FirestoreError(
                      Ke.DEADLINE_EXCEEDED,
                      "Request time out",
                    ),
                  );
                break;
              case De.HTTP_ERROR:
                ...
                if (
                  ...
                  if (t && t.status && t.message) {
                    const e =
                      (function __PRIVATE_mapCodeFromHttpResponseErrorStatus(
                        ...
                        return Object.values(Ke).indexOf(t) >= 0
                          ? t
                          : Ke.UNKNOWN;
                      })(t.status);
                  ...
                  u(new FirestoreError(Ke.UNAVAILABLE, "Connection failed."));
                break;
              default:
                fail();
            }
          } finally {
            __PRIVATE_logDebug(Mt, `RPC '${e}' ${s} completed.`);
          }
        });
      const _ = JSON.stringify(i);
      __PRIVATE_logDebug(Mt, `RPC '${e}' ${s} sending request:`, i),
        l.send(t, "POST", _, n, 15);
    });
  }
  yo(e, t, n) {
    const i = __PRIVATE_generateUniqueDebugId(),
      s = [this.To, "/", "google.firestore.v1.Firestore", "/", e, "/channel"],
      o = new Od(),
      u = Mb(),
      l = {
    ...
    void 0 !== _ && (l.longPollingTimeout = Math.round(1e3 * _)),
      this.useFetchStreams && (l.xmlHttpFactory = new Ne({})),
      this.mo(l.initMessageHeaders, t, n),
      (l.encodeInitMessageHeaders = !0);
    const h = s.join("");
    __PRIVATE_logDebug(Mt, `Creating RPC '${e}' stream ${i}: ${h}`, l);
        ...
        so: (t) => {
          f
            ...
            : (m ||
                ...
                d.open(),
                (m = !0)),
              __PRIVATE_logDebug(Mt, `RPC '${e}' stream ${i} sending:`, t),
              d.send(t));
        },
        oo: () => d.close(),
      }),
    ...
    return (
      __PRIVATE_unguardedEventListen(d, ke.EventType.OPEN, () => {
        f || __PRIVATE_logDebug(Mt, `RPC '${e}' stream ${i} transport opened.`);
      }),
      __PRIVATE_unguardedEventListen(d, ke.EventType.CLOSE, () => {
        f ||
          ((f = !0),
          __PRIVATE_logDebug(Mt, `RPC '${e}' stream ${i} transport closed`),
          g.Po());
      }),
      __PRIVATE_unguardedEventListen(d, ke.EventType.ERROR, (t) => {
        f ||
          ((f = !0),
          __PRIVATE_logWarn(Mt, `RPC '${e}' stream ${i} transport errored:`, t),
          g.Po(
            new FirestoreError(
              Ke.UNAVAILABLE,
      ...
      __PRIVATE_unguardedEventListen(d, ke.EventType.MESSAGE, (t) => {
        var n;
        if (!f) {
          const s = t.data[0];
          ...
          if (u) {
            __PRIVATE_logDebug(Mt, `RPC '${e}' stream ${i} received error:`, u);
            const t = u.status;
            ...
            void 0 === n &&
              ...
              (f = !0),
              g.Po(new FirestoreError(n, s)),
              d.close();
          } else
            __PRIVATE_logDebug(Mt, `RPC '${e}' stream ${i} received:`, s),
              g.Io(s);
        }
      }),
      __PRIVATE_unguardedEventListen(u, Fe.STAT_EVENT, (t) => {
        t.stat === xe
          ? __PRIVATE_logDebug(
              Mt,
...
class __PRIVATE_ExponentialBackoff {
  ...
  Mo(e) {
    this.cancel();
    const t = Math.floor(this.Do + this.xo()),
      n = Math.max(0, Date.now() - this.Co),
      i = Math.max(0, t - n);
    i > 0 &&
      __PRIVATE_logDebug(
        "ExponentialBackoff",
        `Backing off for ${i} ms (base delay: ${this.Do} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`,
      ),
      (this.vo = this.ii.enqueueAfterDelay(
        this.timerId,
        i,
        () => ((this.Co = Date.now()), e()),
      )),
      (this.Do *= this.So),
      this.Do < this.wo && (this.Do = this.wo),
      this.Do > this.bo && (this.Do = this.bo);
  }
  Oo() {
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, i, s, o, u, l) {
    (this.ii = e),
      ...
      (this.qo = null),
      (this.stream = null),
      (this.Qo = new __PRIVATE_ExponentialBackoff(e, t));
  }
  Ko() {
  ...
  Go() {
    this.$o() &&
      null === this.ko &&
      (this.ko = this.ii.enqueueAfterDelay(this.No, 6e4, () => this.zo()));
  }
  jo(e) {
    this.Ho(), this.stream.send(e);
  }
  async zo() {
    if (this.$o()) return this.close(0);
  }
  Ho() {
  ...
  async close(e, t) {
    this.Ho(),
      ...
      4 !== e
        ? this.Qo.reset()
        : t && t.code === Ke.RESOURCE_EXHAUSTED
        ...
        n(
          () => (
            ...
            (this.qo = this.ii.enqueueAfterDelay(
              this.Bo,
              1e4,
              () => (this.$o() && (this.state = 3), Promise.resolve()),
            )),
            this.listener._o()
          ),
        );
...
class __PRIVATE_PersistentWriteStream extends __PRIVATE_PersistentStream {
  ...
  start() {
    (this.s_ = !1), (this.lastStreamToken = void 0), super.start();
  }
  Yo() {
    this.s_ && this.__([]);
  }
  ...
  Ro(e, t, n) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) => this.connection.Ro(e, t, n, i, s))
        .catch((e) => {
          throw "FirebaseError" === e.name
            ? (e.code === Ke.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
                this.appCheckCredentials.invalidateToken()),
              e)
            : new FirestoreError(Ke.UNKNOWN, e.toString());
        })
    );
  }
  po(e, t, n, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) => this.connection.po(e, t, n, s, o, i))
        .catch((e) => {
          throw "FirebaseError" === e.name
            ? (e.code === Ke.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
...
class __PRIVATE_OnlineStateTracker {
  ...
  d_() {
    0 === this.I_ &&
      (this.A_("Unknown"),
      (this.T_ = this.asyncQueue.enqueueAfterDelay(
        "online_state_timeout",
        1e4,
        () => (
          (this.T_ = null),
          this.R_("Backend didn't respond within 10 seconds."),
          this.A_("Offline"),
          Promise.resolve()
        ),
      )));
  ...
  set(e) {
    this.m_(), (this.I_ = 0), "Online" === e && (this.E_ = !1), this.A_(e);
  }
  A_(e) {
  ...
  R_(e) {
    ...
    this.E_
      ? (__PRIVATE_logError(t), (this.E_ = !1))
...
class __PRIVATE_RemoteStoreImpl {
  constructor(e, t, n, i, s) {
    (this.localStore = e),
      ...
      (this.S_ = new __PRIVATE_OnlineStateTracker(n, i));
  }
}
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.y_) await t(!0);
}
async function __PRIVATE_disableNetworkInternal(e) {
  for (const t of e.y_) await t(!1);
}
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.g_.has(t.targetId) ||
    (n.g_.set(t.targetId, t),
    __PRIVATE_shouldStartWatchStream(n)
      ? __PRIVATE_startWatchStream(n)
      : __PRIVATE_ensureWatchStream(n).$o() &&
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.g_.delete(t),
    i.$o() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.g_.size &&
      (i.$o() ? i.Go() : __PRIVATE_canUseNetwork(n) && n.S_.set("Unknown"));
}
function __PRIVATE_sendWatchRequest(e, t) {
  ...
  __PRIVATE_ensureWatchStream(e).r_(t);
}
...
function __PRIVATE_shouldStartWatchStream(e) {
  return (
    ...
    !__PRIVATE_ensureWatchStream(e).Ko() &&
    e.g_.size > 0
  );
}
function __PRIVATE_canUseNetwork(e) {
  return 0 === __PRIVATE_debugCast(e).p_.size;
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e),
    __PRIVATE_shouldStartWatchStream(e)
      ? (e.S_.V_(t), __PRIVATE_startWatchStream(e))
      : e.S_.set("Unknown");
}
          ...
          return (
            n.targetChanges.forEach((n, i) => {
              if (n.resumeToken.approximateByteSize() > 0) {
                const s = e.g_.get(i);
                s && e.g_.set(i, s.withResumeToken(n.resumeToken, t));
              }
            }),
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let i = t.f_.length > 0 ? t.f_[t.f_.length - 1].batchId : -1;
...
function __PRIVATE_canAddToWritePipeline(e) {
  return __PRIVATE_canUseNetwork(e) && e.f_.length < 10;
}
function __PRIVATE_addToWritePipeline(e, t) {
  e.f_.push(t);
  const n = __PRIVATE_ensureWriteStream(e);
  n.$o() && n.o_ && n.__(t.mutations);
}
function __PRIVATE_shouldStartWriteStream(e) {
  return (
    __PRIVATE_canUseNetwork(e) &&
    !__PRIVATE_ensureWriteStream(e).Ko() &&
    e.f_.length > 0
  );
}
...
async function __PRIVATE_onWriteHandshakeComplete(e) {
  ...
  for (const n of e.f_) t.__(n.mutations);
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t &&
    __PRIVATE_ensureWriteStream(e).o_ &&
    (await (async function __PRIVATE_handleWriteError(e, t) {
      if (
        (function __PRIVATE_isPermanentWriteError(e) {
          return __PRIVATE_isPermanentError(e) && e !== Ke.ABORTED;
        })(t.code)
      ) {
        const n = e.f_.shift();
        __PRIVATE_ensureWriteStream(e).Wo(),
          await __PRIVATE_executeWithRecovery(e, () =>
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t
    ? (n.p_.delete(2), await __PRIVATE_enableNetworkInternal(n))
    : t ||
      (n.p_.add(2),
      await __PRIVATE_disableNetworkInternal(n),
      n.S_.set("Unknown"));
...
function __PRIVATE_ensureWatchStream(e) {
  return (
    e.D_ ||
      ((e.D_ = (function __PRIVATE_newPersistentWatchStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
        return (
          i.h_(),
        ...
        n_: __PRIVATE_onWatchStreamChange.bind(null, e),
      })),
      e.y_.push(async (t) => {
        t
          ? (e.D_.Wo(),
            __PRIVATE_shouldStartWatchStream(e)
              ...
              : e.S_.set("Unknown"))
          : (await e.D_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
      })),
    e.D_
  );
}
function __PRIVATE_ensureWriteStream(e) {
  return (
    e.v_ ||
      ((e.v_ = (function __PRIVATE_newPersistentWriteStream(e, t, n) {
        const i = __PRIVATE_debugCast(e);
        return (
          i.h_(),
        ...
        u_: __PRIVATE_onWriteHandshakeComplete.bind(null, e),
        a_: __PRIVATE_onMutationResult.bind(null, e),
      })),
      e.y_.push(async (t) => {
        t
          ? (e.v_.Wo(), await __PRIVATE_fillWritePipeline(e))
          : (await e.v_.stop(),
            e.f_.length > 0 &&
              (__PRIVATE_logDebug(
                "RemoteStore",
                `Stopping write stream with ${e.f_.length} pending writes`,
              ),
              (e.f_ = [])));
      })),
    e.v_
...
function __PRIVATE_wrapInUserErrorIfRecoverable(e, t) {
  if (
    ...
    return new FirestoreError(Ke.UNAVAILABLE, `${t}: ${e}`);
  throw e;
}
class DocumentSet {
  constructor(e) {
...
class __PRIVATE_DocumentChangeSet {
  ...
  track(e) {
    ...
    n
      ? 0 !== e.type && 3 === n.type
        ? (this.C_ = this.C_.insert(t, e))
        : 3 === e.type && 1 !== n.type
        ? (this.C_ = this.C_.insert(t, { type: n.type, doc: e.doc }))
        : 2 === e.type && 2 === n.type
        ? (this.C_ = this.C_.insert(t, { type: 2, doc: e.doc }))
        : 2 === e.type && 0 === n.type
        ? (this.C_ = this.C_.insert(t, { type: 0, doc: e.doc }))
        : 1 === e.type && 0 === n.type
        ? (this.C_ = this.C_.remove(t))
        : 1 === e.type && 2 === n.type
        ? (this.C_ = this.C_.insert(t, { type: 1, doc: n.doc }))
        : 0 === e.type && 1 === n.type
        ? (this.C_ = this.C_.insert(t, { type: 2, doc: e.doc }))
        : fail()
      : (this.C_ = this.C_.insert(t, e));
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  n.queries.set(i, o),
    o.listeners.push(t),
    t.O_(n.onlineState),
    o.M_ && t.N_(o.M_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e of t) {
    const t = e.query,
      s = n.queries.get(t);
    if (s) {
      for (const t of s.listeners) t.N_(e) && (i = !0);
      s.M_ = e;
    }
  }
...
class __PRIVATE_QueryListener {
  ...
  N_(e) {
    ...
    return (
      this.L_
        ? this.q_(e) && (this.B_.next(e), (t = !0))
        : this.Q_(e, this.onlineState) && (this.K_(e), (t = !0)),
      (this.k_ = e),
      t
    );
  }
...
class __PRIVATE_SizedBundleElement {
  constructor(e, t) {
    (this.W_ = e), (this.byteLength = t);
  }
  G_() {
    return "metadata" in this.W_;
  }
}
...
class __PRIVATE_BundleLoader {
  ...
  j_(e) {
    ...
    if (e.W_.namedQuery) this.queries.push(e.W_.namedQuery);
    else if (e.W_.documentMetadata) {
      this.documents.push({ metadata: e.W_.documentMetadata }),
        e.W_.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.W_.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.W_.document &&
        ((this.documents[this.documents.length - 1].document = e.W_.document),
        ++t);
  ...
  async complete() {
    const e = await (async function __PRIVATE_localStoreApplyBundledDocuments(
        ...
        for (const e of n) {
          ...
          const i = t._s(e);
          i.setReadTime(t.us(e.metadata.readTime)), (u = u.insert(n, i));
        }
        const l = s.Xi.newChangeBuffer({ trackRemovals: !0 }),
            ...
            __PRIVATE_populateDocumentChangeBuffer(e, l, u)
              ...
              .next((t) =>
                s.kr
                  ...
                  .next(() => s.kr.addMatchingKeys(e, o, _.targetId))
                  .next(() =>
                    s.localDocuments.getLocalViewOfDocuments(e, t.ns, t.rs),
                  )
                  .next(() => t.ns),
              ),
        );
    ...
    return (
      ...
      { progress: this.progress, J_: this.collectionGroups, Y_: e }
    );
  }
}
...
class __PRIVATE_View {
  constructor(e, t) {
    (this.query = e),
      ...
      (this.ta = __PRIVATE_newQueryComparator(e)),
      (this.na = new DocumentSet(this.ta));
  }
  get ra() {
    return this.Z_;
  }
  ia(e, t) {
    const n = t ? t.sa : new __PRIVATE_DocumentChangeSet(),
      i = t ? t.na : this.na;
        ...
        h && d
          ? h.data.isEqual(d.data)
            ...
            : this.oa(h, d) ||
              ...
              (g = !0),
              ((l && this.ta(d, l) > 0) || (_ && this.ta(d, _) < 0)) &&
                (u = !0))
          : !h && d
    ...
    return { na: o, sa: n, zi: u, mutatedKeys: s };
  }
  oa(e, t) {
    return (
  ...
  applyChanges(e, t, n) {
    const i = this.na;
    (this.na = e.na), (this.mutatedKeys = e.mutatedKeys);
    const s = e.sa.F_();
    s.sort(
      (e, t) =>
        ...
        })(e.type, t.type) || this.ta(e.doc, t.doc),
    ),
      this._a(n);
    const o = t ? this.aa() : [],
      u = 0 === this.ea.size && this.current ? 1 : 0,
      l = u !== this.X_;
    return (
      (this.X_ = u),
      0 !== s.length || l
  ...
  ca(e) {
    return (
      !this.Z_.has(e) && !!this.na.has(e) && !this.na.get(e).hasLocalMutations
    );
  }
  _a(e) {
    e &&
      (e.addedDocuments.forEach((e) => (this.Z_ = this.Z_.add(e))),
      e.modifiedDocuments.forEach((e) => {}),
      e.removedDocuments.forEach((e) => (this.Z_ = this.Z_.delete(e))),
  ...
  aa() {
    ...
    (this.ea = __PRIVATE_documentKeySet()),
      this.na.forEach((e) => {
        this.ca(e.key) && (this.ea = this.ea.add(e.key));
      });
    const t = [];
    return (
      e.forEach((e) => {
  ...
  la(e) {
    (this.Z_ = e.ss), (this.ea = __PRIVATE_documentKeySet());
    const t = this.ia(e.documents);
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, i, s, o) {
    (this.localStore = e),
      ...
      (this.Ia = {}),
      (this.Ta = new ObjectMap(
        (e) => __PRIVATE_canonifyQuery(e),
        __PRIVATE_queryEquals,
      )),
      (this.Ea = new Map()),
      (this.da = new Set()),
      (this.Aa = new SortedMap(DocumentKey.comparator)),
      (this.Ra = new Map()),
      (this.Va = new __PRIVATE_ReferenceSet()),
      (this.ma = {}),
      (this.fa = new Map()),
      (this.ga = __PRIVATE_TargetIdGenerator.On()),
      (this.onlineState = "Unknown"),
      (this.pa = void 0);
  }
  get isPrimaryClient() {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
    ...
    (async function __PRIVATE_applyDocChanges(e, t, n, i) {
      ...
      s.zi &&
        (s = await __PRIVATE_localStoreExecuteQuery(
          ...
          t.query,
          !1,
        ).then(({ documents: e }) => t.view.ia(e, s)));
      const o = i && i.targetChanges.get(t.targetId),
        u = t.view.applyChanges(s, e.isPrimaryClient, o);
      return __PRIVATE_updateTrackedLimbos(e, t.targetId, u.ua), u.snapshot;
    })(e, t, n, i);
  const o = await __PRIVATE_localStoreExecuteQuery(e.localStore, t, !0),
    u = new __PRIVATE_View(t, o.ss),
    l = u.ia(o.documents),
  ...
  __PRIVATE_updateTrackedLimbos(e, n, h.ua);
    ...
    const e = await (function __PRIVATE_localStoreApplyRemoteEventToLocalCache(
      ...
      return n.persistence
        .runTransaction("Apply remote event", "readwrite-primary", (e) => {
          const o = n.Xi.newChangeBuffer({ trackRemovals: !0 });
          s = n.Ji;
          const u = [];
          t.targetChanges.forEach((o, l) => {
            ...
            u.push(
              n.kr
                ...
                .next(() => n.kr.addMatchingKeys(e, o.addedDocuments, l)),
            );
            ...
            null !== t.targetMismatches.get(l)
              ...
              })(_, h, o) && u.push(n.kr.updateTargetData(e, h));
          });
          ...
          if (
            ...
            const t = n.kr
              .getLastRemoteSnapshotVersion(e)
              .next((t) =>
                n.kr.setTargetsMetadata(e, e.currentSequenceNumber, i),
              );
            u.push(t);
          }
    ...
    t.targetChanges.forEach((e, t) => {
      ...
      i &&
        ...
        e.addedDocuments.size > 0
          ...
          ? __PRIVATE_hardAssert(i.Pa)
          : e.removedDocuments.size > 0 &&
            (__PRIVATE_hardAssert(i.Pa), (i.Pa = !1)));
    }),
    ...
    i.Ta.forEach((n, i) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e, t) {
        ...
        n.queries.forEach((e, n) => {
          for (const e of n.listeners) e.O_(t) && (i = !0);
        }),
          i && __PRIVATE_raiseSnapshotsInSyncEvent(n);
      })(i.eventManager, t),
      e.length && i.Ia.n_(e),
      ...
      return n.persistence.runTransaction(
        ...
        (e) => {
          const i = t.batch.keys(),
            s = n.Xi.newChangeBuffer({ trackRemovals: !0 });
...
function __PRIVATE_processUserCallback(e, t, n) {
  const i = __PRIVATE_debugCast(e);
  let s = i.ma[i.currentUser.toKey()];
  if (s) {
    const e = s.get(t);
    e && (n ? e.reject(n) : e.resolve(), (s = s.remove(t))),
      (i.ma[i.currentUser.toKey()] = s);
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  e.sharedClientState.removeLocalQueryTarget(t);
  for (const i of e.Ea.get(t)) e.Ta.delete(i), n && e.Ia.wa(i, n);
  e.Ea.delete(t),
    e.isPrimaryClient &&
      e.Va.Ar(t).forEach((t) => {
        e.Va.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
      });
}
function __PRIVATE_removeLimboTarget(e, t) {
  e.da.delete(t.path.canonicalString());
  const n = e.Aa.get(t);
  null !== n &&
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const i of n)
    i instanceof __PRIVATE_AddedLimboDocument
      ? (e.Va.addReference(i.key, t), __PRIVATE_trackLimboChange(e, i))
      : i instanceof __PRIVATE_RemovedLimboDocument
      ? (__PRIVATE_logDebug(
          "SyncEngine",
          "Document no longer in limbo: " + i.key,
        ),
        e.Va.removeReference(i.key, t),
        e.Va.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key))
      : fail();
}
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.da.size > 0 && e.Aa.size < e.maxConcurrentLimboResolutions; ) {
    const t = e.da.values().next().value;
    e.da.delete(t);
    const n = new DocumentKey(ResourcePath.fromString(t)),
      i = e.ga.next();
    e.Ra.set(i, new LimboResolution(n)),
      (e.Aa = e.Aa.insert(n, i)),
    ...
    await (async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
      ...
      try {
        await n.persistence.runTransaction(
          ...
          (e) =>
            PersistencePromise.forEach(t, (t) =>
              PersistencePromise.forEach(t.Li, (i) =>
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    (n.currentUser = t),
      (function __PRIVATE_rejectOutstandingPendingWritesCallbacks(e, t) {
        e.fa.forEach((e) => {
          e.forEach((e) => {
            e.reject(new FirestoreError(Ke.CANCELLED, t));
          });
        }),
          e.fa.clear();
      ...
      await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.ts);
  }
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e),
    i = n.Ra.get(t);
  if (i && i.Pa) return __PRIVATE_documentKeySet().add(i.key);
  {
    let e = __PRIVATE_documentKeySet();
    const i = n.Ea.get(t);
    if (!i) return e;
...
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  const n = __PRIVATE_debugCast(e),
    ...
    s = t.view.la(i);
  return (
    n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, s.ua), s
  );
}
    ...
    ? ("pending" === n
        ...
        ? (__PRIVATE_processUserCallback(s, t, i || null),
          ...
          (function __PRIVATE_localStoreRemoveCachedMutationBatchMetadata(
            ...
            __PRIVATE_debugCast(__PRIVATE_debugCast(e).mutationQueue).Cn(t);
          })(s.localStore, t))
        : fail(),
...
function __PRIVATE_syncEngineGetActiveClients(e) {
  return (function __PRIVATE_localStoreGetActiveClients(e) {
    return __PRIVATE_debugCast(__PRIVATE_debugCast(e).persistence).Ni();
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.Ia.n_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.Ia.wa = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
  ...
  createPersistence(e) {
    const t =
      void 0 !== this.cacheSizeBytes
        ...
        : LruParams.DEFAULT;
    return new __PRIVATE_MemoryPersistence(
      (e) => __PRIVATE_MemoryLruDelegate.zr(e, t),
      this.serializer,
    );
  }
}
class __PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e),
      await this.ba.initialize(this, e),
      await __PRIVATE_syncEngineEnsureWriteCallbacks(this.ba.syncEngine),
      await __PRIVATE_fillWritePipeline(this.ba.remoteStore),
            ...
            n.Ea.forEach((i, s) => {
              ...
              (function __PRIVATE_resetLimboDocuments(e) {
                ...
                t.Ra.forEach((e, n) => {
                  ...
                  t.Va.Rr(),
                  (t.Ra = new Map()),
                  (t.Aa = new SortedMap(DocumentKey.comparator));
              })(n),
              (n.pa = !1),
              await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !1);
          }
        })(this.ba.syncEngine, e),
          this.gcScheduler &&
  ...
  createRemoteStore(e) {
    return (function __PRIVATE_newRemoteStore(e, t, n, i, s) {
      ...
      (function __PRIVATE_newConnectivityMonitor() {
        return __PRIVATE_BrowserConnectivityMonitor.v()
...
class __PRIVATE_BundleReaderImpl {
  constructor(e, t) {
    (this.Ca = e),
      ...
      (this.Fa = (function __PRIVATE_newTextDecoder() {
        return new TextDecoder("utf-8");
      })()),
      this.Ma().then(
        (e) => {
          e && e.G_()
            ? this.metadata.resolve(e.W_.metadata)
  ...
  close() {
    return this.Ca.cancel();
  }
  async getMetadata() {
    return this.metadata.promise;
  }
  async Sa() {
    return await this.getMetadata(), this.Ma();
  }
  async Ma() {
    const e = await this.xa();
    if (null === e) return null;
    const t = this.Fa.decode(e),
      n = Number(t);
    isNaN(n) && this.Oa(`length string (${t}) is not valid number`);
    const i = await this.Na(n);
  ...
  async xa() {
    for (; this.Ba() < 0 && !(await this.La()); );
    if (0 === this.buffer.length) return null;
    const e = this.Ba();
    e < 0 &&
      this.Oa("Reached the end of bundle when a length string is expected.");
  ...
  async Na(e) {
    for (; this.buffer.length < e; )
      (await this.La()) &&
        this.Oa("Reached the end of bundle when more is expected.");
    const t = this.Fa.decode(this.buffer.slice(0, e));
    return (this.buffer = this.buffer.slice(e)), t;
  }
  Oa(e) {
    throw (this.Ca.cancel(), new Error(`Invalid bundle format: ${e}`));
  }
  async La() {
    const e = await this.Ca.read();
    if (!e.done) {
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
      const n = __PRIVATE_debugCast(e),
        ...
        o = await n.po("BatchGetDocuments", i, s, t.length),
        u = new Map();
      o.forEach((e) => {
...
class __PRIVATE_TransactionRunner {
  constructor(e, t, n, i, s) {
    (this.asyncQueue = e),
      ...
      (this.deferred = s),
      (this.ka = n.maxAttempts),
      (this.Qo = new __PRIVATE_ExponentialBackoff(
        this.asyncQueue,
        "transaction_retry",
      ));
  }
  ...
  Ka(e) {
    this.ka > 0 && this.$a(e)
      ? ((this.ka -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.qa(), Promise.resolve())))
...
class FirestoreClient {
  constructor(e, t, n, i) {
    (this.authCredentials = e),
      ...
      (this.clientId = __PRIVATE_AutoId.V()),
...
function __PRIVATE_canFallbackFromIndexedDbError(e) {
  return "FirebaseError" === e.name
    ? e.code === Ke.FAILED_PRECONDITION || e.code === Ke.UNIMPLEMENTED
    ...
    !(function __PRIVATE_syncEngineLoadBundle(e, t, n) {
      ...
      (async function __PRIVATE_loadBundleImpl(e, t, n) {
        try {
          ...
          let o = await t.Sa();
          for (; o; ) {
            const e = await s.j_(o);
            e && n._updateProgress(e), (o = await t.Sa());
          }
...
function doc(e, t, ...n) {
  if (
    ((e = getModularInstance(e)),
    1 === arguments.length && (t = __PRIVATE_AutoId.V()),
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    (this.Ua = Promise.resolve()),
      ...
      (this.Ja = !1),
      (this.Ya = []),
      (this.Qo = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry")),
      (this.Za = () => {
        const e = getDocument();
        e &&
          __PRIVATE_logDebug(
  ...
  enqueue(e) {
    if ((this.Xa(), this.Ga)) return new Promise(() => {});
  ...
  enqueueRetryable(e) {
    this.enqueueAndForget(() => (this.Wa.push(e), this.tu()));
  }
  async tu() {
    if (0 !== this.Wa.length) {
      try {
    ...
    return e.asyncQueue.enqueue(async () => {
      ...
      return (
        ...
        (function __PRIVATE_remoteStoreEnableNetwork(e) {
          const t = __PRIVATE_debugCast(e);
          return t.p_.delete(0), __PRIVATE_enableNetworkInternal(t);
        })(n)
      );
    });
  })(ensureFirestoreConfigured((e = __PRIVATE_cast(e, Firestore))));
...
class __PRIVATE_ParseContextImpl {
  ...
  Iu(e) {
    return this.uu({ path: void 0, lu: !0 });
  }
  Tu(e) {
  ...
  _u() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++) this.hu(this.path.get(e));
  }
  hu(e) {
    if (0 === e.length) throw this.Tu("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.au) && Ot.test(e))
      throw this.Tu('Document fields cannot begin and end with "__"');
  }
}
...
function __PRIVATE_parseSetData(e, t, n, i, s, o = {}) {
  const u = e.Au(o.merge || o.mergeFields ? 2 : 0, t, n, s);
...
function __PRIVATE_createSentinelChildContext(e, t, n) {
  return new __PRIVATE_ParseContextImpl(
    { au: 3, du: t.settings.du, methodName: e._methodName, lu: n },
    t.databaseId,
    t.serializer,
    t.ignoreUndefinedProperties,
  );
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, !0),
      n = this.Ru.map((e) => __PRIVATE_parseData(e, t)),
...
function __PRIVATE_parseQueryValue(e, t, n, i = !1) {
  return __PRIVATE_parseData(n, e.Au(i ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if ((t.path && t.fieldMask.push(t.path), e instanceof Array)) {
    if (t.settings.lu && 4 !== t.au)
      throw t.Tu("Nested arrays are not supported");
    return (function __PRIVATE_parseArray(e, t) {
      const n = [];
      let i = 0;
      for (const s of e) {
        let e = __PRIVATE_parseData(s, t.Iu(i));
  ...
  return (function __PRIVATE_parseScalarValue(e, t) {
    ...
    throw t.Tu(`Unsupported field value: ${__PRIVATE_valueDescription(e)}`);
  })(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return (
    isEmpty(e)
      ...
      : forEach(e, (e, i) => {
          const s = __PRIVATE_parseData(i, t.cu(e));
          null != s && (n[e] = s);
        }),
    { mapValue: { fields: n } }
  );
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (
    ...
    throw "an object" === i ? t.Tu(e + " a custom object") : t.Tu(e + " " + i);
  }
}
...
function __PRIVATE_createError(e, t, n, i, s) {
  ...
  return (
    (o || u) &&
      ...
      u && (_ += ` in document ${s}`),
      (_ += ")")),
    new FirestoreError(Ke.INVALID_ARGUMENT, l + e + _)
  );
}
...
class QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(e) {
    const t = (function __PRIVATE_newQueryOrderBy(e, t, n) {
      ...
      const i = new OrderBy(t, n);
      return (
        (function __PRIVATE_validateNewOrderBy(e, t) {
          if (null === __PRIVATE_getFirstOrderByField(e)) {
            const n = __PRIVATE_getInequalityFilterField(e);
            null !== n &&
              __PRIVATE_validateOrderByAndInequalityMatch(e, n, t.field);
          }
        })(e, i),
        i
      );
...
function __PRIVATE_validateNewFieldFilter(e, t) {
  if (t.isInequality()) {
    const n = __PRIVATE_getInequalityFilterField(e),
      i = t.field;
    if (null !== n && !n.isEqual(i))
      throw new FirestoreError(
        Ke.INVALID_ARGUMENT,
        `Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '${n.toString()}' and '${i.toString()}'`,
      );
    const s = __PRIVATE_getFirstOrderByField(e);
    null !== s && __PRIVATE_validateOrderByAndInequalityMatch(e, i, s);
  }
    ...
    return (
      e.asyncQueue.enqueueAndForget(async () =>
        (function __PRIVATE_addSnapshotsInSyncListener(e, t) {
          __PRIVATE_debugCast(e).x_.add(t), t.next();
          ...
          try {
            ...
            i.sharedClientState.addPendingMutation(e.batchId),
              (function __PRIVATE_addMutationCallback(e, t, n) {
                let i = e.ma[e.currentUser.toKey()];
                i || (i = new SortedMap(__PRIVATE_primitiveComparator)),
                  (i = i.insert(t, n)),
                  (e.ma[e.currentUser.toKey()] = i);
              })(i, e.batchId, n),
              await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(
                i,
                e.changes,
...
function getAggregateFromServer(e, t) {
  const n = __PRIVATE_cast(e.firestore, Firestore),
    ...
    s = (function __PRIVATE_mapToArray(e, t) {
      ...
      t,
      (e, t) =>
        new __PRIVATE_AggregateImpl(t, e._aggregateType, e._internalFieldPath),
    );
            ...
            (async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
              ...
              const s = __PRIVATE_debugCast(e),
                { request: o, P_: u } =
                  ...
                  })(s.serializer, __PRIVATE_queryToTarget(t), n),
                l = o.parent;
              s.connection.Ao || delete o.parent;
              const _ = (await s.po("RunAggregationQuery", l, o, 1)).filter(
                (e) => !!e.result,
              );
...
function runTransaction(e, t, n) {
  ...
  const i = Object.assign(Object.assign({}, Bt), n);
  return (
