      ...
      : (function (e) {
          ...
          for (; n < e.length; ) {
            ...
            if (o < 128) t[r++] = String.fromCharCode(o);
              ...
              const s = e[n++];
              t[r++] = String.fromCharCode(((31 & o) << 6) | (63 & s));
            } else if (o > 239 && o < 365) {
              const s =
                (((7 & o) << 18) |
                  ((63 & e[n++]) << 12) |
...
class ErrorFactory {
  ...
  create(e, ...t) {
    ...
    return new FirebaseError(r, a, n);
  }
}
const o = /\{\$([^}]+)}/g;
...
function encode(e) {
  ...
  if (Array.isArray(e)) return e.map((e) => encode(e));
  if ("function" == typeof e || "object" == typeof e)
    return mapValues(e, (e) => encode(e));
...
class FunctionsService {
  constructor(e, t, n, r, o = "us-central1", s) {
    (this.app = e),
      (this.fetchImpl = s),
      (this.emulatorOrigin = null),
      (this.contextProvider = new ContextProvider(t, n, r)),
  ...
  _url(e) {
    ...
    if (null !== this.emulatorOrigin) {
      return `${this.emulatorOrigin}/${t}/${this.region}/${e}`;
    }
...
function httpsCallable$1(e, t, n) {
  return (r) =>
    (function call(e, t, n, r) {
      const o = e._url(t);
      return callAtURL(e, o, n, r);
    })(e, t, r, n || {});
}
async function postJSON(e, t, n, r) {
  let o;
  n["Content-Type"] = "application/json";
  try {
    o = await r(e, { method: "POST", body: JSON.stringify(t), headers: n });
  } catch (e) {
  ...
  return { status: o.status, json: s };
}
async function callAtURL(e, t, n, r) {
  const o = { data: (n = encode(n)) },
    i = {},
    a = await e.contextProvider.getContext(r.limitedUseAppCheckTokens);
  a.authToken && (i.Authorization = "Bearer " + a.authToken),
    a.messagingToken && (i["Firebase-Instance-ID-Token"] = a.messagingToken),
    null !== a.appCheckToken && (i["X-Firebase-AppCheck"] = a.appCheckToken);
  const c = (function failAfter(e) {
      let t = null;
      return {
        promise: new Promise((n, r) => {
          t = setTimeout(() => {
            r(new FunctionsError("deadline-exceeded", "deadline-exceeded"));
          }, e);
        }),
        cancel: () => {
          t && clearTimeout(t);
  ...
  const l = (function _errorForResponse(e, t) {
    let n,
      r = (function codeForHTTPStatus(e) {
    ...
    try {
      ...
      if (e) {
        const t = e.status;
        if ("string" == typeof t) {
          if (!s[t]) return new FunctionsError("internal", "internal");
          (r = s[t]), (o = t);
        }
        const i = e.message;
        "string" == typeof i && (o = i),
    ...
    return "ok" === r ? null : new FunctionsError(r, o, n);
  })(u.status, u.json);
  if (l) throw l;
  if (!u.json)
    throw new FunctionsError("internal", "Response is not valid JSON object.");
  let h = u.json.data;
  if ((void 0 === h && (h = u.json.result), void 0 === h))
    throw new FunctionsError("internal", "Response is missing data field.");
  return { data: decode(h) };
}
const i = "@firebase/functions";
function getFunctions(e = n(), t = "us-central1") {
  const r = _getProvider(getModularInstance(e), "functions").getImmediate({
      identifier: t,
    }),
    o = getDefaultEmulatorHostnameAndPort("functions");
  return o && connectFunctionsEmulator(r, ...o), r;
}
function connectFunctionsEmulator(e, t, n) {
  !(function connectFunctionsEmulator$1(e, t, n) {
    e.emulatorOrigin = `http://${t}:${n}`;
  })(getModularInstance(e), t, n);
}
function httpsCallable(e, t, n) {
  return httpsCallable$1(getModularInstance(e), t, n);
}
function httpsCallableFromURL(e, t, n) {
  return (function httpsCallableFromURL$1(e, t, n) {
    return (r) => callAtURL(e, t, r, n || {});
  })(getModularInstance(e), t, n);
}
!(function registerFunctions(n, r) {
  e(
    new Component(
      "functions",
      (e, { instanceIdentifier: t }) => {
        const r = e.getProvider("app").getImmediate(),
          ...
          s = e.getProvider("messaging-internal"),
          i = e.getProvider("app-check-internal");
        return new FunctionsService(r, o, s, i, t, n);
      },
      "PUBLIC"
